...
FROM
(SELECT a.CODE, t.ID , t.VISIBLE
FROM GISVIEWER_PLIM35.APPLICATIE a,GISVIEWER_PLIM35.THEMAS t, KAARTENBALIE_PLIM35.ORGANIZATION_LAYERS ol, KAARTENBALIE_PLIM35.USERS u, KAARTENBALIE_PLIM35.LAYER l, KAARTENBALIE_PLIM35.SERVICE_PROVIDER s, KAARTENBALIE_PLIM35.USERS_ORGS us
WHERE u.id = us.users AND us.ORGANIZATION  = ol.ORGANIZATION AND ol.LAYER = l.ID AND t.WMS_LAYERS_REAL = s.ABBR || '_' || l.NAME AND u.PERSONALURL = a.GEBRUIKERS_CODE AND u.MAIN_ORGANIZATION != us.ORGANIZATION);
