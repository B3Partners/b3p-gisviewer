...
public class EditFeature {
    ...
    /**
     * Retrieves the featuretype of a given Gegevensbron. It is a JSONObject, which follows the next scheme:
     * {
     *  success: boolean,
     *  featurename: String,
     *  gegevensbronId: Integer,
     *  values: Array of editable columns in the format  
        * {
        *  columnname: String,
        *  label: String,
        *  units: String,
        *  defaultValues: (optional) Array of defaults,
        *  type: String with the datatype of the column
        * },
     *  readonly: Array of non-editable columns in the format         
        * {
        *  columnname: String,
        *  label: String,
        *  units: String,
        ...
        *  type: String with the datatype of the column
        * },
        * geom_attribute : (optional if editable) String
        * geom_type : (optional if editable) String [Polygon|LineString|Point]
     * }
    ...
    /**
     * Get features given a WKT and a distance from a Gegevensbron. This follows the format:
        * {
        *  success: boolean,
        *  features: (optional if success ==  true) Array of JSONObjects, following the format:
        * 
        *  featurename: String,
        *  gegevensbronId: Integer,
        *  values: Array of editable columns in the format  
        ...
        *  readonly: Array of non-editable columns in the format         
           ...
           * },
         * geom_attribute : (optional if editable) String,
         * geom : (optional if editable and known) String of Well Known Text
        * }
     * @param gegevensBronId The id of the Gegevensbron
     * @param wkt   The Well Known Text of the clicking point
     * @param distance  The Distance for which the wkt must be buffered. Important for scale dependend retrieval of features
     ...
     * belonging to the feature with the following format:
     *         * {
        *  success: boolean,
        *  features: (optional if success ==  true) Array of JSONObjects, following the format:
        * 
     ...
     * @return the following JSONObject:
     *         * {
        *  success: boolean,
        *  features: (optional if success ==  true) Array of JSONObjects, following the format:
        * 
    ...
    /**
     * Remove a feature
     * @param json The identification of the feature(s) to be deleted. Use the format:
     * {
     *  fid: the featureId,
     *  gegevensbronId: id (integer) of the gegevensbron from which the feature must be deleted
     * }
     * @return
     * @throws JSONException 
     */
