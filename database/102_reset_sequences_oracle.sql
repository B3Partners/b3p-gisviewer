...
create sequence bron_id_seq INCREMENT BY 1 START WITH 4;
create sequence clusters_id_seq INCREMENT BY 1 START WITH 4;
create sequence configuratie_id_seq INCREMENT BY 1 START WITH 345;
create sequence data_typen_id_seq INCREMENT BY 1 START WITH 5;
create sequence resultaatveld_id_seq INCREMENT BY 1 START WITH 7;
create sequence thema_data_id_seq INCREMENT BY 1 START WITH 319;
create sequence themas_id_seq INCREMENT BY 1 START WITH 11;
create sequence waarde_typen_id_seq INCREMENT BY 1 START WITH 7;
create sequence zoekconfiguratie_id_seq INCREMENT BY 1 START WITH 2;
create sequence zoekveld_id_seq INCREMENT BY 1 START WITH 2;
